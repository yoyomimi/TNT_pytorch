...
# create background
_C.VIDEO_PATH = '' # absolute path
_C.BG = CN()
_C.BG.NMS_THRESHOLD = 0.1
_C.BG.VAR = 30.0
_C.BG.REC_BIAS = 12
_C.BG.VALID_SIZE = 20.0
_C.BG.OUTPUT_DIR = ''
...
_C.IDENTIFIER.FILE = ''
_C.IDENTIFIER.NAME = ''
_C.IDENTIFIER.IS_TRAIN = False
_C.IDENTIFIER.NUM_CLASSES = 2
_C.IDENTIFIER.SIZE = 28
# dataset
_C.IDENTIFIER.DATASET_FILE = ''
_C.IDENTIFIER.DATASET_NAME = ''
# identifier train
_C.IDENTIFIER.LR = 0.005
_C.IDENTIFIER.WEIGHT_DECAY = 0.0001
# identifier learning rate scheduler
_C.IDENTIFIER.LR_STEPS = [120000, ]
_C.IDENTIFIER.LR_FACTOR = 0.1
_C.IDENTIFIER.WARMUP_STEP = 500
_C.IDENTIFIER.WARMUP_INIT_FACTOR = 1.0 / 3
_C.IDENTIFIER.MAX_ITERATIONS = 360000
# identifier resume
_C.IDENTIFIER.RESUME = False
_C.IDENTIFIER.WEIGHTS = ''
_C.IDENTIFIER.IS_VAL = False
...
_C.LOSS = CN()
_C.LOSS.INF = 1e8
_C.LOSS.REGRESS_RANGES = ((-1, INF), (-1, INF), (-1, INF))
