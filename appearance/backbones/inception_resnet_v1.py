...
from units.units import BasicConv2d
...
class InceptionResnetV1(nn.Module):
    ...
    """
    def __init__(self, pretrained=None, classify=False, num_classes=None, dropout_prob=0.6, device=None, path=None):
        super().__init__()
        ...
        if pretrained is not None and path is not None:
            load_weights(self, pretrained, local_path=path)
...
def load_weights(mdl, name, local_path):
    ...
    """
    if name == 'vggface2':
        features_path = local_path[0]
        logits_path = local_path[1]
